...
wrap.innerHTML = <div class="kpiLabel">${escapeHtml(v.card?.label || "Orders")}</div> <div class="kpiValue">${escapeHtml(v.card?.value || value.toLocaleString())}</div> <div class="kpiHint">Single value</div> ;
return wrap;
}
